 ...
 */
final class ModelSchemaAdapter
{
    public function __construct()
    {
        // Minimal constructor - all logic delegated to ModelSchema
    }
    ...
    public function parseMultipleDocuments(string $filePath): array
    {
        ...
        foreach ($documentStrings as $documentString) {
            $documentString = mb_trim($documentString);
            if ($documentString !== '' && $documentString !== '0') {
    ...
    public function getStatistics(): array
    {
        ...
        return [
            ...
            'geometric_types' => array_filter($types, function ($type): bool {
     ...
     */
    private function enhanceFieldTypes(array $yamlData): array
    {
